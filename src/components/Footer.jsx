...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-sky-900 via-sky-800 to-emerald-900 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              <div className="bg-white p-2 rounded-full mr-3">
                <Recycle className="w-6 h-6 text-sky-600" />
              </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center text-sky-100">
                <MapPin className="w-4 h-4 mr-3 text-sky-300" />
          ...
          <div id="services">
            <h4 className="text-xl font-semibold mb-6 flex items-center">
              <Leaf className="w-5 h-5 mr-2 text-sky-300" />
              Our Services
            </h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={index}>
                  <Link
                    to={service.path}
                    className="flex items-center text-sky-100 hover:text-white transition-colors group cursor-pointer"
                  >
                    <ChevronRight className="w-4 h-4 mr-2 text-sky-300 group-hover:translate-x-1 transition-transform" />
                    {service.name}
                  </Link>
                </li>
              ))}
            ...
            {/* <div className="mb-6">
              <div className="relative">
                <input
                  ...
                  className="w-full p-3 rounded-lg bg-white/10 border border-sky-400/30 text-white placeholder-sky-200 focus:outline-none focus:border-sky-300 focus:bg-white/20 transition-all"
                />
                <button
                  onClick={handleSubscribe}
                  className="absolute right-1 top-1 bottom-1 px-4 bg-sky-500 hover:bg-sky-400 rounded-md transition-colors flex items-center justify-center"
                >
                  <Mail className="w-4 h-4" />
                </button>
              </div>
              {isSubscribed && (
                <p className="text-sky-300 text-sm mt-2 animate-pulse">
        ...
        <div className="border-t border-sky-700/50 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-sky-200 mb-4 md:mb-0">
          ...
          <div className="mt-6 text-center">
            <div className="inline-flex items-center bg-sky-800/50 px-4 py-2 rounded-full text-sky-100">
              <Leaf className="w-4 h-4 mr-2 text-sky-300" />
